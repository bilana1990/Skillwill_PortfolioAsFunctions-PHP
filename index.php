...
<script src='https://kit.fontawesome.com/a076d05399.js' crossorigin='anonymous'></script>
    ...
    <body>
        ...
        <div class="div1"> 
            <?php
            section1("Heloo<br>I am <span>Giorgi Bilanishvili</span><br>
            <br>
            I am student of Skillwill Academy<br>
            I am fullstack web develober</p>
            <br>");
            ?>
            </div>
            <!-- <div class="div1"> 
            <p>Hello,<br>
                <br>
            <span>I am <span class="span1">Giorgi Bilanishvili</span></span><br>
            <br>
            I am student of Skillwill Academy<br>
            I am fullstack web develober</p>
            <br>
            <a href="https://files.fm/u/hum82t3sb" target="_blank">download CV</a>
            </div> -->

            <div class="div2">
                <img src="img/gio poto.jpg" alt="">
            </div>
        </section>


        <section class="section2" id="section2">
            <img src="img/gio poto.jpg" alt="img">
            <div class="div1">
                <?php
                section2("i am fulstack webdeveloper, i am student of skillwill academy");
                ?>
                <!--  
            <h2>I Am fullstack web developer</h2>
        ...
        <footer id="footer">
            <div class="div1">
                ...
                <a href="tel:+995598699007">+995 598699007</a>
                <img src="img/envelope logo.png" alt="">
                <a href="mailto:giobilana@gmail.com">giobilana@gmail.com</a>
                <p>Tbilisi, Georgia</p>
            </div>
